...
>
> Этот проект не является официальным SDK Boxberry, не связан с компанией
> Boxberry, не поддерживается, не одобрен и не спонсируется правообладателем.
>
> Обозначение «Boxberry» используется исключительно для указания совместимости
> SDK с API соответствующего сервиса. Все права на товарный знак «Boxberry»
> принадлежат его правообладателю.
>
> **Unofficial independent project**
>
> This is not an official Boxberry SDK. The project is not affiliated with,
> maintained, endorsed, or sponsored by Boxberry or the trademark owner.
> The “Boxberry” name is used solely to identify API compatibility.
...
- 0.8.10 - Изменяет адрес api по умолчанию и актуализирует README
...
- 0.4.0 - Реализованы основные функции API [справка API](https://api.boxberry.ru/?act=info&sub=api_info_lk);
- 0.3.0 - Реализованы основные функции API [сервисов BoxBerry](https://api.boxberry.ru/?act=info&sub=api_info_services).
